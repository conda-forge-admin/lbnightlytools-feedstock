...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/lbnightlytools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lbnightlytools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add lbnightlytools
# for installing globally
pixi global install lbnightlytools
```
...
It is possible to list all of the versions of `lbnightlytools` available on your platform:
...
```
pixi search lbnightlytools --channel conda-forge
```
